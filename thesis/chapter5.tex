...
Integrate SAM3 and Depth Anything 3 for real-time ice detection and depth estimation. Fine-tune these models on collected datasets to improve domain-specific performance.

\subsubsection{3DGS Training and Evaluation}

Complete the 3DGS reconstruction pipeline by:
\begin{itemize}
    \item Implementing proper pose transformation
