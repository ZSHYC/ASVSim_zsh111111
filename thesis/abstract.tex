...
Experimental validation demonstrates the effectiveness of the data collection system, with successful acquisition of 200-frame sequences containing synchronized multi-sensor data. The results show consistent pose estimation, complete depth coverage of the scene, and high-quality LiDAR point clouds with 8,192 points per frame. This work establishes a foundation for future integration of perception, reconstruction, and planning modules in polar navigation scenarios.
