...
% 页眉：论文标题居中（双页和单页都显示标题）
\fancyhead[C]{\fontsize{10.5pt}{15.75pt}\selectfont Polar Route Planning and 3D Reconstruction Using Unreal Engine and 3D Gaussian Splatting}
\fancyfoot[C]{\thepage}
...
\renewcommand{\headrule}{%
  ...
  \begin{tikzpicture}
    ...
    \draw[line width=1.5pt] (0,-2pt) -- (\textwidth,-2pt);
  \end{tikzpicture}
  \vspace{2pt}
}
