...
% 目录格式设置
\usepackage{tocloft}
\renewcommand{\contentsname}{\centering Contents}  % 标题改为Contents并居中
\setlength{\cftbeforesecskip}{0.2em}  % 减小目录章节间距
\setlength{\cftbeforesubsecskip}{0.1em}  % 减小二级标题间距
\setlength{\cftbeforesubsubsecskip}{0.05em}  % 减小三级标题间距
% 确保所有级别都有虚线连接到页码
