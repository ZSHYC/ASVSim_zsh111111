...
\thispagestyle{empty}
\begin{center}
{\fontsize{16pt}{24pt}\selectfont\bfseries 哈尔滨工程大学}\\[0.5cm]
{\fontsize{16pt}{24pt}\selectfont\bfseries 学位论文原创性声明}
\end{center}
...
\thispagestyle{empty}
\begin{center}
{\fontsize{16pt}{24pt}\selectfont\bfseries Harbin Engineering University}\\[0.5cm]
{\fontsize{16pt}{24pt}\selectfont\bfseries Declaration of Originality}
\end{center}
...
\begin{center}
{\fontsize{16pt}{24pt}\selectfont\bfseries 哈尔滨工程大学}\\[0.5cm]
{\fontsize{16pt}{24pt}\selectfont\bfseries 学位论文授权声明}
\end{center}
...
\begin{center}
{\fontsize{16pt}{24pt}\selectfont\bfseries Harbin Engineering University}\\[0.5cm]
{\fontsize{16pt}{24pt}\selectfont\bfseries Thesis Authorization Statement}
\end{center}
